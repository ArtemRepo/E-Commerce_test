...
public class EmployeeAdapterClass extends RecyclerView.Adapter<EmployeeAdapterClass.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.editTextName.setText(employeeModelClass.getName());
        holder.editTextEmail.setText(employeeModelClass.getEmail());

        holder.button_Edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String stringName = holder.editTextName.getText().toString();
                String stringEmail = holder.editTextEmail.getText().toString();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            editTextEmail = itemView.findViewById(R.id.edittext_email);
